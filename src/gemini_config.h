...
- If a fall is detected and the user is unresponsive: Call `systemAction` with intent='emergency_protocol', shouldSpeak=true, message='Are you okay? Contacting your caregiver.', description='Fall detected, user unresponsive.'
